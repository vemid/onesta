! function(e) {
    ...
    return function i(a, f, l) {
        ...
        for (var s = "function" == typeof require && require, e = 0; e < l.length; e++) c(l[e]);
        return c
    }({
        1: [function(e, t, o) {
            "use strict";
            ...
            var l = function(e, t) {
                ...
                f = function() {
                    ...
                    n.classList.add("basicLightbox"), null != o.className && (e = n.classList).add.apply(e, function(e) {
                        if (Array.isArray(e)) {
                    ...
                    var r = n.querySelector(".basicLightbox__placeholder"),
                        ...
                        a = l(r, "VIDEO"),
                        f = l(r, "IFRAME");
                    return !0 === i && n.classList.add("basicLightbox--img"), !0 === a && n.classList.add("basicLightbox--video"), !0 === f && n.classList.add("basicLightbox--iframe"), n
                };
            o.create = function(e, n) {
                ...
                var i = {
                    ...
                    show: function(e) {
                        return !1 !== n.beforeShow(i) && (t = r, o = function() {
